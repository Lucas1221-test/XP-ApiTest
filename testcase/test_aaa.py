...
"""测试数据路径"""
data_path0 = data_path + 'test_product_information.yaml'
...
class Test:
    ...
    @pytest.mark.parametrize("caseinfo",
                             read_case_yaml(data_path0,
                            'test_query_product_information'))
    def query_product_information(self, caseinfo):
    ...
    def save_product_code(self, caseinfo):
        allure.dynamic.story(caseinfo['story'])
        allure.dynamic.title(caseinfo['title'])
        RequestUtils().standard_yaml_case(caseinfo)
    ...
    @pytest.mark.parametrize("caseinfo",
                             read_case_yaml(data_path0,
                            'test_save_product'))
    def save_product(self, caseinfo):
        allure.dynamic.story(caseinfo['story'])
        allure.dynamic.title(caseinfo['title'])
        RequestUtils().standard_yaml_case(caseinfo)
...
class Test1:
    ...
    def ump_market_calendar(self, caseinfo):
        allure.dynamic.story(caseinfo['story'])
        allure.dynamic.title(caseinfo['title'])
        RequestUtils().standard_yaml_case(caseinfo)
    ...
    @pytest.mark.parametrize("caseinfo",
                             read_case_yaml(new_data_path,
                                            'test_init_calendar'))
    def init_calendar(self, caseinfo):
        allure.dynamic.story(caseinfo['story'])
        allure.dynamic.title(caseinfo['title'])
        RequestUtils().standard_yaml_case(caseinfo)
